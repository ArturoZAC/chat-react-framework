import { Plan, type Client, type Message } from "~/chat/interfaces/chat.interface";
...
const messages: Message[] = [
  ...
  // María Vargas (C1-81678)
  {
    id: "M1-23456",
    clientId: "C1-81678",
    content: "Tengo problemas para acceder a mi cuenta. Me dice credenciales incorrectas.",
  ...
  // José Hernández (C1-60078)
  {
    id: "M1-34567",
    clientId: "C1-60078",
    content: "¿Cuáles son las nuevas características del plan Pro que contraté?",
  ...
  // Roberto Quirós (C1-56789)
  {
    id: "M1-45678",
    clientId: "C1-56789",
    content: "Necesitamos agregar 5 usuarios más a nuestra cuenta Enterprise. ¿Cuál es el proceso?",
  ...
  // Sofía Blanco (C1-65432)
  {
    id: "M1-56789",
    clientId: "C1-65432",
    content: "Estamos considerando actualizar a un plan con más capacidad. ¿Qué nos recomiendan?",
